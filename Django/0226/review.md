...
templates > blog > blog_delete.html (생성x 이 템플릿은 실무에서는 필요하지 않습니다.)

################################
# blog > forms.py 생성 후 작성
...
class PostForm(forms.Form):  # PostForm은 여러분이 원하는 이름으로 바꿔도 됩니다.
    title = forms.CharField()
    contents = forms.CharField()
